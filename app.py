# import all funtions and classes from the Flask module
from flask import *

# the below module to help us interact with the database
import pymysql
import pymysql.cursors

# Intialize a new Flask application instance
app =Flask(__name__) #entry point of server ,,main
from flask_cors import CORS
CORS(app)
# import Os module to for interaction with the operationg system
import os
# configure the directory where the uploaded file will be saved.
app.config['UPLOAD_FOLDER'] = 'static/images'

# Define a route for the 'signup' API endpoint, accepting only POST request
...
def mpesa_payment():
    if request.method == 'POST':
        ...
        payload = {
            ...
            "AccountReference": "Cliff Enterprises",
